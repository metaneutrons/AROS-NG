...
function(aros_build_ahi)
    ...
    if(NOT _source_manifest_hash STREQUAL _AROS_AHI_SOURCE_MANIFEST_SHA256)
        message(FATAL_ERROR "AHI: source input manifest differs from its audited SHA-256")
    endif()
    ...
    if(NOT _product_manifest_hash STREQUAL _expected_product_hash)
        message(FATAL_ERROR "AHI: product manifest differs from its audited SHA-256")
    endif()
    ...
    foreach(_line IN LISTS _source_lines)
        ...
        if(NOT _input_hash STREQUAL _digest)
            message(FATAL_ERROR "AHI: source input ${_relative} differs from its manifest")
        endif()
    ...
    set(_dependency_lexical
        "${_build_root_lexical}/liblinklibs-amiga.a"
        "${_build_root_lexical}/liblinklibs-libm.a"
        "${_build_root_lexical}/liblinklibs-mui.a")
    ...
    set(AHI_SOURCE_MANIFEST_SHA256 "${_AROS_AHI_SOURCE_MANIFEST_SHA256}")
    set(AHI_PRODUCT_MANIFEST "${_product_manifest}")
    set(AHI_PRODUCT_MANIFEST_SHA256 "${_expected_product_hash}")
