...
set(_required
    ...
    AHI_CC AHI_COLLECT AHI_AS AHI_AR AHI_RANLIB AHI_OBJCOPY AHI_STRIP AHI_LLD
    AHI_SDK_INCLUDE
...
if(NOT AHI_MMAKE_ID STREQUAL _AROS_AHI_MMAKE_ID OR
   NOT AHI_MODE MATCHES "^(x86_64|arm|aarch64)$")
...
if(NOT AHI_TARGET_TRIPLE STREQUAL _expected_triple OR
...
foreach(_name IN ITEMS
        ...
        AHI_HOST_FLEXCAT AHI_FLEXCAT AHI_MAKE AHI_CC AHI_COLLECT AHI_AS AHI_AR
        AHI_RANLIB AHI_OBJCOPY AHI_STRIP AHI_LLD AHI_SDK_INCLUDE)
...
foreach(_name IN ITEMS SOURCE_MANIFEST PRODUCT_MANIFEST HOST_SFDC HOST_PERL
        HOST_FLEXCAT FLEXCAT MAKE CC COLLECT AS AR RANLIB OBJCOPY STRIP LLD)
    _aros_ahi_real_path("${AHI_${_name}}" _${_name})
endforeach()
...
foreach(_path IN ITEMS
        ...
        _CC _COLLECT _AS _AR _RANLIB _OBJCOPY _STRIP _LLD _SDK_INCLUDE _GEN_INCLUDE)
...
foreach(_tool IN ITEMS _HOST_SFDC _HOST_PERL _HOST_FLEXCAT _FLEXCAT _MAKE _CC
        _COLLECT _AS _AR _RANLIB _OBJCOPY _STRIP _LLD)
...
if(NOT _source_hash STREQUAL AHI_SOURCE_MANIFEST_SHA256 OR
   NOT _product_hash STREQUAL AHI_PRODUCT_MANIFEST_SHA256)
    message(FATAL_ERROR "AHI runner manifest changed after configuration; rerun CMake")
endif()
...
endforeach()
if(NOT _input_relative STREQUAL AHI_INPUT_RELATIVE)
...
list(LENGTH AHI_INPUT_SHA256 _input_hash_count)
if(NOT _input_count EQUAL _input_hash_count)
    message(FATAL_ERROR "AHI runner contract input hash count differs from inventory")
endif()
...
if(_last_input GREATER_EQUAL 0)
    foreach(_index RANGE 0 ${_last_input})
        ...
        list(GET AHI_INPUT_SHA256 ${_index} _expected_hash)
        ...
        if(NOT _actual_hash STREQUAL _expected_hash)
            message(FATAL_ERROR
                "AHI runner: source input changed after configuration; rerun CMake")
        endif()
    endforeach()
endif()
